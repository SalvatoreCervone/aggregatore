...
export const studentData = [
  { Scuola: 'Liceo Galilei', Genere: 'F', Livello: 'Anno 1', Materia: 'Matematica', Voto: 8.5, OreStudio: 6 },
  { Scuola: 'Liceo Galilei', Genere: 'F', Livello: 'Anno 1', Materia: 'Fisica', Voto: 7.0, OreStudio: 5 },
  { Scuola: 'Liceo Galilei', Genere: 'F', Livello: 'Anno 2', Materia: 'Matematica', Voto: 9.0, OreStudio: 8 },
  { Scuola: 'Liceo Galilei', Genere: 'M', Livello: 'Anno 1', Materia: 'Matematica', Voto: 6.5, OreStudio: 4 },
  { Scuola: 'Liceo Galilei', Genere: 'M', Livello: 'Anno 1', Materia: 'Fisica', Voto: 8.0, OreStudio: 7 },
  { Scuola: 'Liceo Galilei', Genere: 'M', Livello: 'Anno 2', Materia: 'Matematica', Voto: 7.5, OreStudio: 5 },

  { Scuola: 'Istituto Fermi', Genere: 'F', Livello: 'Anno 1', Materia: 'Matematica', Voto: 7.0, OreStudio: 4 },
  { Scuola: 'Istituto Fermi', Genere: 'F', Livello: 'Anno 1', Materia: 'Fisica', Voto: 6.5, OreStudio: 3 },
  { Scuola: 'Istituto Fermi', Genere: 'F', Livello: 'Anno 2', Materia: 'Matematica', Voto: 8.0, OreStudio: 6 },
  { Scuola: 'Istituto Fermi', Genere: 'M', Livello: 'Anno 1', Materia: 'Matematica', Voto: 8.0, OreStudio: 6 },
  { Scuola: 'Istituto Fermi', Genere: 'M', Livello: 'Anno 1', Materia: 'Fisica', Voto: 8.5, OreStudio: 7 },
  { Scuola: 'Istituto Fermi', Genere: 'M', Livello: 'Anno 2', Materia: 'Matematica', Voto: 7.0, OreStudio: 4 }
];

export const iotData = [
  { Stanza: 'Soggiorno', Sensore: 'Termostato', Stato: 'Attivo', Temperatura: 21.5, Umidità: 45 },
  { Stanza: 'Soggiorno', Sensore: 'Umidostato', Stato: 'Attivo', Temperatura: 21.0, Umidità: 48 },
  { Stanza: 'Soggiorno', Sensore: 'Termostato', Stato: 'Inattivo', Temperatura: 19.5, Umidità: 42 },
  
  { Stanza: 'Cucina', Sensore: 'Termostato', Stato: 'Attivo', Temperatura: 22.8, Umidità: 55 },
  { Stanza: 'Cucina', Sensore: 'Rilevatore Fumo', Stato: 'Attivo', Temperatura: 23.0, Umidità: 52 },
  
  { Stanza: 'Camera Letto', Sensore: 'Termostato', Stato: 'Attivo', Temperatura: 19.0, Umidità: 40 },
  { Stanza: 'Camera Letto', Sensore: 'Umidostato', Stato: 'Attivo', Temperatura: 19.5, Umidità: 41 },
  { Stanza: 'Camera Letto', Sensore: 'Termostato', Stato: 'Inattivo', Temperatura: 18.0, Umidità: 39 }
];

export const wdrReportConfig = {
  dataSource: {
    data: [
      { Prodotto: 'Laptop', Marca: 'Dell', Anno: 2024, Unità: 15, Ricavo: 15000 },
      { Prodotto: 'Laptop', Marca: 'Dell', Anno: 2025, Unità: 20, Ricavo: 20000 },
      { Prodotto: 'Laptop', Marca: 'Apple', Anno: 2024, Unità: 12, Ricavo: 18000 },
      { Prodotto: 'Tablet', Marca: 'Apple', Anno: 2024, Unità: 30, Ricavo: 15000 },
      { Prodotto: 'Tablet', Marca: 'Apple', Anno: 2025, Unità: 25, Ricavo: 12500 }
    ]
  },
  slice: {
    rows: [
    ...
    measures: [
      { uniqueName: 'Ricavo', aggregation: 'sum', caption: 'Fatturato Marca' },
      { uniqueName: 'Unità', aggregation: 'sum', caption: 'Unità Vendute' }
    ]
  }
};
